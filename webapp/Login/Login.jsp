...
<html lang="en" xmlns:c="https://jakarta.ee/xml/ns/jakartaee">
  <head>
    ...
    <script src="../WEB-INF/views/javascript/login.js"></script>
  </head>
  <body>
    <!-- LOGIN MODULE -->
    <div class="login">
      <div class="wrap">
        ...
        <div class="user">
          ...
          <div class="logo">
            <a href="#"
              ><img
                src="https://res.cloudinary.com/dpcloudinary/image/upload/v1506186248/logo.png"
                alt=""
            /></a>
          </div>
          <!-- TOGGLE -->
          ...
          <div class="terms">
            ...
            <p>
              You may need a dp Account in order to use some of our Services.
              You may create your own dp Account, or your dp Account may be
              assigned to you by an administrator, such as your employer or
              educational institution. If you are using a dp Account assigned to
              you by an administrator, different or additional terms may apply
              and your administrator may be able to access or disable your
              account.
            </p>
            <p>
              To protect your dp Account, keep your password confidential. You
              are responsible for the activity that happens on or through your
              dp Account. Try not to reuse your dp Account password on
            ...
            <p>
              ...
              sorry to see you go. dp may also stop providing Services to you,
            ...
            <p>
              WHEN PERMITTED BY LAW, dp, AND dp’S SUPPLIERS AND DISTRIBUTORS,
              WILL NOT BE RESPONSIBLE FOR LOST PROFITS, REVENUES, OR DATA,
              FINANCIAL LOSSES OR INDIRECT, SPECIAL, CONSEQUENTIAL, EXEMPLARY,
              OR PUNITIVE DAMAGES.
            </p>
            <p>
              TO THE EXTENT PERMITTED BY LAW, THE TOTAL LIABILITY OF dp’S, AND
          ...
          <div class="recovery">
            ...
            <p>
              Enter either the <strong>email address</strong> or
              <strong>username</strong> on the account and
              <strong>click Submit</strong>
            </p>
            <p>We'll email instructions on how to reset your password.</p>
            <form
              class="recovery-form"
              action="passwordRecovery.jsp"
              method="post"
            >
              <input
                type="text"
          ...
          <div class="form-wrap">
            ...
            <div class="tabs-content">
              ...
              <div id="signup-tab-content">
                <form class="signup-form" action="signup.jsp" method="post">
                  <input
                    type="email"
                    class="input"
                    name="user_email"
